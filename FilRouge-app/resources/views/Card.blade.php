    ...
    <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        <div class="rounded-lg md:w-2/3">
            ...
            <div class="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
                <img
                    src="{{ asset('./assets/images/Rectangle 44.png') }}"
        ...
        <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
            ...
            <button class="mt-6 w-full rounded-md bg-green-800 py-1.5 font-medium text-green-50 hover:bg-green-600">Check
                out
            </button>
            <a href="/All_products">
                <button
                    class="mx-auto mt-2 w-full middle none center rounded-lg bg-gray-600 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-gray-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
