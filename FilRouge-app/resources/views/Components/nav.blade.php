...
<nav id="bar" class="flex justify-center ">
    <div class="sm:mb-0 self-center">
        ...
        <a href="/All_products" class="text-md no-underline text-grey-darker hover:text-blue-dark ml-2 px-1">Products</a>
        <a href="/Contact" class="text-md no-underline text-grey-darker hover:text-blue-dark ml-2 px-1">Contact Us</a>
        <a href="/FAQ" class="text-md no-underline text-grey-darker hover:text-blue-dark ml-2 px-1">FAQ</a>
        <a href="#" class="text-md no-underline text-grey-darker hover:text-blue-dark ml-2 px-1">About Us</a>
