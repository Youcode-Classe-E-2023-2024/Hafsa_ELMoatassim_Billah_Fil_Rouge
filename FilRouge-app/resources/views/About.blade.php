...
<div class="bg-white relative   flex items-center  n justify-center overflow-hidden z-50 ">
    ...
    <div class="flex">
        <div class="navbar absolute inset-x-0 top-8 transform -translate-y-1/2 flex justify-center z-10">
    ...
    <div
        ...
        <div class="flex flex-col items-center justify-between lg:flex-row py-16">
            <div class=" relative ">
                <div class="lg:max-w-xl lg:pr-5 relative pt-10 z-40">
            ...
            <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
                ...
                <div
                    ...
                    <img src="{{ asset('./assets/images/Rectangle 49.png') }}">
                </div>
            </div>
        </div>
    </div>
